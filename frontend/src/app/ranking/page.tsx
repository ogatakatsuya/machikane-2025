...
const UpdateIndicator = ({ isUpdating }: { isUpdating: boolean }) => {
  return (
    ...
    >
      <div className="bg-blue-900/60 rounded-full px-4 py-2 flex items-center gap-2 border-2 border-cyan-400/50 shadow-lg shadow-cyan-500/20">
        <div
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-blue-950 via-blue-900 to-cyan-900 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="z-10 text-center">
          <div className="bg-blue-950/80 rounded-3xl px-12 py-10 border-3 border-cyan-400/60 shadow-2xl shadow-cyan-500/20">
            ...
            <div className="text-cyan-300/80 text-lg mb-6">
              最初の挑戦者になりませんか？ 🚀
            </div>
            <div className="flex items-center justify-center gap-4 text-cyan-300/70 text-sm border-t border-cyan-500/30 pt-4">
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-950 via-blue-900 to-cyan-900 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-4">
        ...
        <div className="text-center mb-12">
          <div className="inline-block bg-blue-950/80 rounded-3xl px-8 py-6 border-3 border-cyan-400/60 shadow-2xl shadow-cyan-500/20">
        ...
        {/* 4位以下のランキングリスト */}
        {remaining.length > 0 && (
          <div className="bg-blue-950/80 rounded-3xl p-6 border-3 border-cyan-400/60 shadow-2xl shadow-cyan-500/20">
        ...
        {rankings.length > 0 && rankings.length < 4 && (
          <div className="mt-8 text-center">
            <div className="inline-block bg-blue-950/60 rounded-2xl px-8 py-6 border-2 border-cyan-400/40 shadow-xl">
              <div className="text-4xl mb-3">🌟</div>
              <p className="text-cyan-200 text-lg font-bold mb-2">
                まだまだ挑戦者を募集中！
              </p>
