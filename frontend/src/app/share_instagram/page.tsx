...
import { notoSansJP } from "@/fonts/noto-sans-jp";
...
const ShareInstagramContent = () => {
  ...
  return (
    <div className="fixed left-0 top-0">
      <div className={`w-[1080px] h-[1920px] bg-gradient-to-b from-blue-950 via-blue-900 to-cyan-900 flex flex-col items-center justify-between p-20 text-white relative overflow-hidden ${notoSansJP.className}`}>
        {/* 背景 */}
